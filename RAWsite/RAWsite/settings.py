"""
Django settings for RAWsite project.
...
SECRET_KEY = 'zurx*cqi&b=46%p3w+3sha8dfx%g-uly*v83%dd)4%ifi&m%o)'
...
WSGI_APPLICATION = 'RAWsite.wsgi.application'
